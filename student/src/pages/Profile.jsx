            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <div className="space-y-6">
               ...
               <div>
                  ...
                  <div className="mt-1 flex items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-gray-400 mr-2" viewBox="0 0 20 20" fill="currentColor">
                      <path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.518 3.11a1 1 0 01-.217.885L5.4 8.4a11.037 11.037 0 005.2 5.2l1.559-1.559a1 1 0 01.885-.217l3.11.518a1 1 0 01.836.986V17a1 1 0 01-1 1h-1C7.716 18 2 12.284 2 5V3z" />
                    </svg>
                    <p className="text-gray-900 font-medium">{profile?.phoneNumber || "Not specified"}</p>
                  </div>
               </div>
