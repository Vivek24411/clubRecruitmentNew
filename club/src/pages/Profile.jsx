...
const Profile = () => {
  ...
  const [userName, setUserName] = useState(
    clubProfile ? clubProfile.userName : ""
  );
  const [shortDescription, setShortDescription] = useState(
    clubProfile ? clubProfile.shortDescription : ""
  );
  const [longDescription, setLongDescription] = useState(
    clubProfile ? clubProfile.longDescription : ""
  );
  const [website, setWebsite] = useState(
    clubProfile ? clubProfile.website : ""
  );
  const [linkedin, setLinkedin] = useState(
    clubProfile ? clubProfile.linkedin : ""
  );
  const [instagram, setInstagram] = useState(
    clubProfile ? clubProfile.instagram : ""
  );
  const [achivements, setAchivements] = useState(
    clubProfile ? clubProfile.achivements : ""
  );
  const [recruitmentMethods, setRecruitmentMethods] = useState(
    clubProfile ? clubProfile.recruitmentMethods : ""
  );
  const [contactEmail, setContactEmail] = useState(
    clubProfile ? clubProfile.contactEmail : ""
  );
  const [contactPhone, setContactPhone] = useState(
    clubProfile ? clubProfile.contactPhone : ""
  );
              ...
              <div className="bg-[#1a4b8e] px-6 py-4">
                <div className="flex flex-col md:flex-row md:items-center justify-between">
                  ...
                  <div>
                    ...
                    <button
                      className="mt-2 md:mt-0 ml-2 bg-red-500 text-white px-4 py-1 rounded-lg font-medium hover:bg-red-600 transition-colors"
                      onClick={logout}
                    >
                      Logout
                    </button>
                    ...
                    {clubProfile.contactEmail && (
                      <div className="flex items-center">
                        ...
                        <div className="ml-3">
                          ...
                          <a
                            href={`mailto:${clubProfile.contactEmail}`}
                            className="text-[#1a4b8e] hover:underline"
                          >
                            {clubProfile.contactEmail}
                          </a>
                        </div>
                    ...
                    {clubProfile.contactPhone && (
                      <div className="flex items-center">
                        ...
                        <div className="ml-3">
                          ...
                          <a
                            href={`tel:${clubProfile.contactPhone}`}
                            className="text-[#1a4b8e] hover:underline"
                          >
                            {clubProfile.contactPhone}
                          </a>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                    {websiteUrl && (
                      ...
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          className="h-5 w-5 text-[#1a4b8e] mr-2"
                          viewBox="0 0 20 20"
                          fill="currentColor"
                        >
                          <path
          ...
          <div className="bg-white shadow rounded-lg overflow-hidden">
            ...
            <form onSubmit={updateProfile} className="p-6">
              ...
              <div className="mt-8 flex justify-end">
                ...
                <button
                  type="submit"
                  className={`bg-[#1a4b8e] text-white px-4 py-2 rounded-lg hover:bg-[#143b72] transition-colors flex items-center ${
