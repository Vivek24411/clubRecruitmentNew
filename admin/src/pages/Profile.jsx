...
const Profile = () => {
    ...
    return (
      <div style={styles.container}>
        <div style={styles.card}>
          <p>Error: Context not available. Please make sure AdminContext provider is properly set up.</p>
        </div>
      </div>
    );
  }
  ...
  const avatarLetter = adminProfile.email ? adminProfile.email[0].toUpperCase() : "A";
      ...
      <div style={styles.card}>
        <div style={styles.header}>
          ...
          <div>
            ...
            <p style={styles.subtitle}>System administrator account</p>
          </div>
        </div>
        ...
        <div style={styles.infoSection}>
          ...
          <div style={styles.infoRow}>
            ...
            <div style={styles.infoValue}>System Administrator</div>
          </div>
          
          <div style={styles.infoRow}>
            <div style={styles.infoLabel}>Access Level</div>
            <div style={styles.infoValue}>Full Access</div>
          </div>
        </div>
      </div>
    </div>
