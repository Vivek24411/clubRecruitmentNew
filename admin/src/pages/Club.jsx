...
const Club = () => {
    ...
    const fetchClubDetails = React.useCallback(async () => {
        try {
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                                {websiteUrl && (
                                    <div className="bg-gray-50 rounded-lg p-4">
                                        ...
                                        <a href={websiteUrl} target="_blank" rel="noopener noreferrer" className="text-[#1a4b8e] hover:underline flex items-center">
                                ...
                                {linkedinUrl && (
                                    <div className="bg-gray-50 rounded-lg p-4">
                                        ...
                                        <a href={linkedinUrl} target="_blank" rel="noopener noreferrer" className="text-[#1a4b8e] hover:underline flex items-center">
                                ...
                                {instagramUrl && (
                                    <div className="bg-gray-50 rounded-lg p-4">
                                        ...
                                        <a href={instagramUrl} target="_blank" rel="noopener noreferrer" className="text-[#1a4b8e] hover:underline flex items-center">
                                            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" fill="currentColor" viewBox="0 0 24 24">
